...
@Component({
  ...
  imports: [AudioPlayerComponent, IonRange, IonLabel, IonFabButton, IonText, IonSkeletonText, IonGrid, IonCol, IonRow, IonItem, IonImg, IonButton, IonIcon, IonBackButton, IonButtons, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
export class PlayerPage implements OnInit {

  title = 'I Have a Dream';
  filename = 'I_Have_a_Dream.mp3';
  curr_playing_file: MediaObject | undefined;
  ...
  createAudioFile(pathToDirectory: string, filename: string): MediaObject {
    if (this.platform.is('ios')) {
      //ios
